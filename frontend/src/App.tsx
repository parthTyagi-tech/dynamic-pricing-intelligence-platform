...
function AppRoutes() {
  ...
  return <><Routes><Route path="/login" element={<AuthPage />} /><Route path="/signup" element={<AuthPage />} /><Route element={<ProtectedLayout onToast={(message) => push(message)} />}><Route index element={<Navigate to="/dashboard" replace />} /><Route path="/dashboard" element={<DashboardPage />} /><Route path="/catalog" element={<SecondaryPage kind="catalog" />} /><Route path="/approvals" element={<SecondaryPage kind="approvals" />} /><Route path="/agents" element={<SecondaryPage kind="agents" />} /><Route path="/pricing" element={<PricingPage />} /><Route path="/competitors" element={<CompetitorsPage />} /><Route path="/settings" element={<SettingsPage />} /><Route path="*" element={<Navigate to="/dashboard" replace />} /></Route></Routes><ToastStack toasts={toasts} dismiss={dismiss} /></>;
}
